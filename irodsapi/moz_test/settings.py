...
SECURE_SSL_REDIRECT = env.bool('IRODS_API_SECURE_SSL_REDIRECT', default=False)
...
TUS_FILE_NAME_FORMAT = env.str('IRODS_API_TUS_FILE_NAME_FORMAT', default='keep')
...
#CELERY_BROKER_URL = 'amqp://<user>:<pass>@<host>:<port>//'

#CELERY_BEAT_SCHEDULE = {"sync_irods": {"task": "demo.tasks.sync_irods", "schedule": 480, "options": {"queue": "<queue>"}}}
